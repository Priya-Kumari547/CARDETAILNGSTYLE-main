        ...
        <div className="row align-items-center m-d-block bobile_block">
          <div className="col-md-12 col-lg-12 interior_mob">
            <div className="inner_content_detailing">
              ...
              <h1 className="mb-5 mb-lg-4 section-title">{title}</h1>
              <p>{description}</p>
              <button className="btn btn-primary mt-3 btn-custom" onClick={handleBookNowClick}>
                BOOK NOW
              </button>
            </div>
          </div>
          <div className="col-md-12 col-lg-12 pt-5 pt-lg-0 interior_mob mt-lg-5 mt-sm-0">
            {/* <Slider {...settings}>
