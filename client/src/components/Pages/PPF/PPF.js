...
function PPF() {
    ...
    const contentData = {
        ...
        description: `PPF is typically made from a durable, self-healing material that can absorb impacts and prevent damage to the underlying paint. It is commonly applied to high-impact areas such as the front bumper, hood, side mirrors, and door edges, but can be installed on any painted surface of the vehicle.
            In addition to its protective propserties, PPF is also known for its optical clarity, allowing the natural beauty of your vehicle's paint to shine through without any distortion. It is virtually invisible once installed, providing seamless protection without altering the appearance of your car.
