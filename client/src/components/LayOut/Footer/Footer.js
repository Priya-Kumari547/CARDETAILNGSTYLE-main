      ...
      <div className="footer">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-5 col-md-6">
              ...
              <div className="footer-link">    
                ...
                <div className="footer-social mb-2 mt-0">
                  ...
                  <a className="btn" href="https://www.facebook.com/profile.php?id=61560190021984&mibextid=LQQJ4d">
                    <i className="fab fa-facebook-f"></i>
                  </a>
                  {/* <a className="btn" href="#">
                    <i className="fab fa-youtube"></i>
                  </a> */}
                  <a className="btn" href="https://www.instagram.com/detailingmastersbendigo?igsh=MWEzOHlyNWJubzVpeA%3D%3D&utm_source=qr">
                    <i className="fab fa-instagram"></i>
                  </a>
                  <a className="btn" href="https://www.tiktok.com/@detailing.masters03?_t=8mj8OMnSQTg&_r=1">
            ...
            <a href="https://www.softflixitsolutions.com/" target="_blank" rel="noopener noreferrer">SoftflixItSolutions</a>
          </p>
              {/* {/ <h2>Get In Touch</h2> /} */}
              {/* <p>
            ...
            <div className="col-lg-7 col-md-6">
              ...
              <li className="footer-contact-links">
                <Link to="tel:+61483078520"> <i class="fa fa-phone-alt"></i></Link>
                <Link to="tel:+61483078520">+61-483078520</Link>
              </li>
              </div>
              <div class="top-bar-text">
                  {/* <h3>Email Us</h3> */}
                ...
                <Link to="/ExteriorDetailing" className="nav-link">Exterior Detailing</Link>
   <Link to="/Ext&Int" className="nav-link">Exterior & Interior Detailing</Link>

    <Link to="/PreSaleDetail" className="nav-item nav-link"> PRE SALE DETAIL</Link>
    <Link to="/CermaicCoating" className="nav-link">Ceramic Coating</Link>
   
    <Link to="/WindowTining" className="nav-link">Window Tinting & PPF</Link>
    <Link to="/Corporate" className="nav-item nav-link"> CORPRATE & Heavy Vehicles</Link>
                </li>
              </div>
            </div>
