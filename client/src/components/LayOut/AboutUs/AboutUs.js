...
import img from "../../../Assest/NACSupplyInc-210103-Driveway-Water-Damage-Blogbanner1_2048x.jpg";
import AOS from "aos";
            ...
            <div className="col-lg col-md-12">
              <div className="aboutus_main ps-4">
                ...
                <div className="benefit"  data-aos="fade-up"
                  ...
                  <p>
                    Welcome to Detailing , where excellence meets dedication. At Detailing Masters, we pride ourselves on upholding the highest standards of car care in the industry, earning us a distinguished reputation for excellence. Our commitment to exceptional service begins with our unwavering dedication to treating every customer like gold, ensuring your satisfaction remains our top priority. With a focus on delivering the highest quality service, we prioritize convenience, professionalism, and value in every interaction. Our goal is simple: to exceed your expectations at every turn. We stand behind our work with a guarantee of satisfaction.
                  </p>
